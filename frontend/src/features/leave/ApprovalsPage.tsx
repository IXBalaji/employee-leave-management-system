    ...
    },
    {
      ...
      render: (r) => (
        <div style={{ display: 'flex', gap: 'var(--space-2)' }}>
          ...
          <button className="_iconBtn_k7m22_4" onClick={() => {}}>
            <svg viewBox="0 0 24 24" width="16" height="16"><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12z" fill="currentColor"/></svg>
          </button>
        </div>
      ),
    },
