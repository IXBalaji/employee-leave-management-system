  ...
  return (
    <>
      <div className={styles.shell}>
        ...
        {/* a11y-violation 4/5: button-name — icon-only button with no accessible name (WCAG 4.1.2 Name, Role, Value) */}
        <button type="button" className={styles.navToggle} onClick={() => {}}>
